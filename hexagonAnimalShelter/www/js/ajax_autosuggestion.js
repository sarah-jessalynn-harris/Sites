...
function suggest(query) {
    ...
    xmlHttp.open("GET", base_url + "/index.php/animal/suggest/" + query, true);
...
function displayTitles(titles) {
 ...
 //console.log(titles);
    ...
    for (i = 0; i < titles.length; i++) {
        divContent += "<a id=s_" + i + " onclick='clickTitle(this)'>" + titles[i] + "</a>";
    }
...
//    suggestionBoxObj.style.marginTop = '-200px';
//    suggestionBoxObj.style.top = '200px';
}
...
function handleKeyUp(e) {
    ...
    if (e.keyCode === 38 && activeTitle > 0) {
        ...
        activeTitleObj.style.backgroundColor = "#90A2D0";
        activeTitle--;
        activeTitleObj = document.getElementById("s_" + activeTitle);
        activeTitleObj.style.backgroundColor = "#4A67AD";
